...
use Carbon\Carbon;
use App\Rules\MeetingRoomAvailability;

use Illuminate\Foundation\Http\FormRequest;

class StoreRoomBooking extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            ...
            'roombooking.room_id' => ['required', new MeetingRoomAvailability($meetingRoomID,$meetingStartTime,$meetingEndTime)],
    ...
    {
        return [
            'roombooking.start_time.after' => 'A room booking must be done at least 30 minutes from the current time.',
        ];
    }
}
