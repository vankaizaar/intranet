...
class DeletedRoomBooking extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->greeting('Hello!')
            ->subject('Cancelled & Deleted Meeting: ' . $this->roombooking->title)
            ->line('The following meeting, of which you were an attendee, has been cancelled and/or deleted.')
