...
<div class="d-sm-flex d-md-block wrapper mt-md-4 w-full v-center">
    <a href="#" class="header-toggler d-md-none mr-auto order-first" data-toggle="collapse"
...
<div class="h-100 w-100 position-relative to-top cursor b-b mt-md-5" data-action="click->layouts--html-load#goToTop"
    title="{{ __('Go to top') }}" style="border-bottom: 1px solid rgba(233, 236, 239, 0.05);">
